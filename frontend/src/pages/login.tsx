          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-[--gray-7] bg-[--gray-2] px-3 py-2.5 text-sm text-[--gray-12] outline-none ring-0 transition placeholder:text-[--gray-10] focus:border-[--accent-8]"
              />
            </div>
